  ...
  return (
    <footer className="w-full mb-[50px] md:mb-5 pb-10" id="contact">
      ...
      <div className="flex flex-col items-center">
        ...
        <a href="mailto:fareedzafar657@gmail.com">
          <MagicButton
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center space-y-10 lg:space-y-0">
        <p className="md:text-base text-sm md:font-normal font-light">
          Copyright © 2024 Fareed Zafar
        </p>
